...
const inputStyles = `mb-5 w-full rounded-lg bg-primary-300 px-5 py-3 placeholder-white`;
  ...
  return <section id="contactus" className="mx-auto w-5/6 pt-24 pb-32">
    ...
    <p className="my-5">Maecenas faucibus turpis vitae dui mollis, ac ultrices metus rhoncus. 
    Mauris sit amet lorem maximus, condimentum nunc et, blandit quam. Integer quis mattis metus. 
    Morbi facilisis pharetra nisl tristique aliquam. Curabitur semper lectus consequat, ornare tellus placerat, fringilla libero.</p>
    </motion.div>
    {/* Form and Image */}
